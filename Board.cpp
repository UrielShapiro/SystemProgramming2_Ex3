...
ariel::Board::Board()
{
    ...
    vertices.push_back(new ariel::Vertex(SEA, SEA, MOUNTAIN, id++));         // 0
    vertices.push_back(new ariel::Vertex(SEA, MOUNTAIN, SEA, id++));         // 1
    vertices.push_back(new ariel::Vertex(SEA, PASTURES, MOUNTAIN, id++));    // 2
    vertices.push_back(new ariel::Vertex(HILL, PASTURES, MOUNTAIN, id++));   // 3
    vertices.push_back(new ariel::Vertex(HILL, MOUNTAIN, FIELD, id++));      // 4
    vertices.push_back(new ariel::Vertex(SEA, FIELD, MOUNTAIN, id++));       // 5
    vertices.push_back(new ariel::Vertex(SEA, SEA, PASTURES, id++));         // 6
    vertices.push_back(new ariel::Vertex(SEA, PASTURES, FOREST, id++));      // 7
    vertices.push_back(new ariel::Vertex(PASTURES, PASTURES, FOREST, id++)); // 8
    vertices.push_back(new ariel::Vertex(PASTURES, PASTURES, HILL, id++));   // 9
    vertices.push_back(new ariel::Vertex(SEA, SEA, FOREST, id++));           // 10
    vertices.push_back(new ariel::Vertex(SEA, SEA, FOREST, id++));           // 11
    vertices.push_back(new ariel::Vertex(SEA, HILL, FOREST, id++));          // 12
    vertices.push_back(new ariel::Vertex(PASTURES, HILL, FOREST, id++));     // 13
    vertices.push_back(new ariel::Vertex(PASTURES, HILL, FOREST, id++));     // 14
    vertices.push_back(new ariel::Vertex(FOREST, HILL, MOUNTAIN, id++));     // 15
    vertices.push_back(new ariel::Vertex(SEA, HILL, MOUNTAIN, id++));        // 16
    vertices.push_back(new ariel::Vertex(SEA, SEA, HILL, id++));             // 17
    vertices.push_back(new ariel::Vertex(DESERT, FOREST, PASTURES, id++));   // 18
    vertices.push_back(new ariel::Vertex(PASTURES, HILL, DESERT, id++));     // 19
    vertices.push_back(new ariel::Vertex(FOREST, HILL, DESERT, id++));       // 20
    vertices.push_back(new ariel::Vertex(FOREST, HILL, FIELD, id++));        // 21
    vertices.push_back(new ariel::Vertex(FIELD, FIELD, FOREST, id++));       // 22
    vertices.push_back(new ariel::Vertex(FIELD, FIELD, SEA, id++));          // 23
    vertices.push_back(new ariel::Vertex(SEA, SEA, FIELD, id++));            // 24
    vertices.push_back(new ariel::Vertex(SEA, SEA, FIELD, id++));            // 25
    vertices.push_back(new ariel::Vertex(SEA, SEA, FIELD, id++));            // 26
    vertices.push_back(new ariel::Vertex(SEA, FIELD, FOREST, id++));         // 27
    vertices.push_back(new ariel::Vertex(FOREST, FIELD, FOREST, id++));      // 28
    vertices.push_back(new ariel::Vertex(MOUNTAIN, FOREST, FOREST, id++));   // 29
    vertices.push_back(new ariel::Vertex(FOREST, DESERT, MOUNTAIN, id++));   // 30
    vertices.push_back(new ariel::Vertex(DESERT, FIELD, MOUNTAIN, id++));    // 31
    vertices.push_back(new ariel::Vertex(FOREST, FIELD, DESERT, id++));      // 32
    vertices.push_back(new ariel::Vertex(PASTURES, FIELD, FOREST, id++));    // 33
    vertices.push_back(new ariel::Vertex(PASTURES, FOREST, MOUNTAIN, id++)); // 34
    vertices.push_back(new ariel::Vertex(SEA, PASTURES, MOUNTAIN, id++));    // 35
    vertices.push_back(new ariel::Vertex(SEA, SEA, MOUNTAIN, id++));         // 36
    vertices.push_back(new ariel::Vertex(SEA, SEA, MOUNTAIN, id++));         // 37
    vertices.push_back(new ariel::Vertex(SEA, SEA, PASTURES, id++));         // 38
    vertices.push_back(new ariel::Vertex(SEA, PASTURES, PASTURES, id++));    // 39
    vertices.push_back(new ariel::Vertex(FIELD, PASTURES, PASTURES, id++));  // 40
    vertices.push_back(new ariel::Vertex(FIELD, FIELD, PASTURES, id++));     // 41
    vertices.push_back(new ariel::Vertex(FIELD, FIELD, MOUNTAIN, id++));     // 42
    vertices.push_back(new ariel::Vertex(HILL, FIELD, MOUNTAIN, id++));      // 43
    vertices.push_back(new ariel::Vertex(FOREST, HILL, MOUNTAIN, id++));     // 44
    vertices.push_back(new ariel::Vertex(SEA, FOREST, HILL, id++));          // 45
    vertices.push_back(new ariel::Vertex(SEA, SEA, FOREST, id++));           // 46
    vertices.push_back(new ariel::Vertex(SEA, SEA, HILL, id++));             // 47
    vertices.push_back(new ariel::Vertex(SEA, SEA, HILL, id++));             // 48
    vertices.push_back(new ariel::Vertex(SEA, FIELD, HILL, id++));           // 49
    vertices.push_back(new ariel::Vertex(SEA, SEA, FIELD, id++));            // 50
    vertices.push_back(new ariel::Vertex(SEA, SEA, PASTURES, id++));         // 51
    vertices.push_back(new ariel::Vertex(SEA, SEA, PASTURES, id++));         // 52
    vertices.push_back(new ariel::Vertex(SEA, SEA, PASTURES, id++));         // 53
    ...
    tiles.push_back(new ariel::Tile(v_number++, 10, MOUNTAIN, tile1_e, tile1_v));
    ...
    tiles.push_back(new ariel::Tile(v_number++, 2, PASTURES, tile2_e, tile2_v));
    ...
    tiles.push_back(new ariel::Tile(v_number++, 9, FOREST, tile3_e, tile3_v));
    ...
    tiles.push_back(new ariel::Tile(v_number++, 10, HILL, tile4_e, tile4_v));
    ...
    tiles.push_back(new ariel::Tile(v_number++, 4, PASTURES, tile5_e, tile5_v));
    ...
    tiles.push_back(new ariel::Tile(v_number++, 6, HILL, tile6_e, tile6_v));
    ...
    tiles.push_back(new ariel::Tile(v_number++, 12, FIELD, tile7_e, tile7_v));
    ...
    tiles.push_back(new ariel::Tile(v_number++, 9, FIELD, tile8_e, tile8_v));
    ...
    tiles.push_back(new ariel::Tile(v_number++, 11, FOREST, tile9_e, tile9_v));
    ...
    tiles.push_back(new ariel::Tile(v_number++, 7, DESERT, tile10_e, tile10_v));
    ...
    tiles.push_back(new ariel::Tile(v_number++, 3, FOREST, tile11_e, tile11_v));
    ...
    tiles.push_back(new ariel::Tile(v_number++, 8, MOUNTAIN, tile12_e, tile12_v));
    ...
    tiles.push_back(new ariel::Tile(v_number++, 8, FOREST, tile13_e, tile13_v));
    ...
    tiles.push_back(new ariel::Tile(v_number++, 3, MOUNTAIN, tile14_e, tile14_v));
    ...
    tiles.push_back(new ariel::Tile(v_number++, 4, FIELD, tile15_e, tile15_v));
    ...
    tiles.push_back(new ariel::Tile(v_number++, 5, PASTURES, tile16_e, tile16_v));
    ...
    tiles.push_back(new ariel::Tile(v_number++, 11, PASTURES, tile17_e, tile17_v));
    ...
    tiles.push_back(new ariel::Tile(v_number++, 6, FIELD, tile18_e, tile18_v));
    ...
    tiles.push_back(new ariel::Tile(v_number++, 5, HILL, tile19_e, tile19_v));
}
        ...
        if (std::find(tile->get_vertices().begin(), tile->get_vertices().end(), v) != tile->get_vertices().end()) // If not found, an iterator to the end will be returned.
        {
            for (size_t i = 0; i < VERTICES_PER_TILE; i++)
            {
                if (tile->get_vertices().at(i)->get_id() == v.get_id())
                {
                    ...
                    if (!tile->get_vertices().at(good_mod(i + 1, VERTICES_PER_TILE))->is_free() &&
                        tile->get_vertices().at(good_mod(i + 1, VERTICES_PER_TILE))->get_building()->get_owner().get_id() != p.get_id())
                    {
                        return false;
                    }
                    ...
                    if (tile->get_edges().at(good_mod(i - 1, EDGES_PER_TILE))->isTaken() &&
                        tile->get_edges().at(good_mod(i - 1, EDGES_PER_TILE))->get_owner()->get_id() == p.get_id())
                    {
                        return true;
                    }
                }
        ...
        if (std::find(tile->get_edges().begin(), tile->get_edges().end(), e) != tile->get_edges().end()) // If not found, an iterator to the end will be returned.
        {
            for (size_t i = 0; i < EDGES_PER_TILE; i++)
            {
                if (tile->get_edges().at(i)->get_id() == e.get_id())
                {
                    ...
                    if (tile->get_edges().at(good_mod(i - 1, EDGES_PER_TILE))->get_owner() == nullptr) // If this place has no road yet
                    {
                        continue;
                    }
                    if (!tile->get_edges().at(good_mod(i - 1, EDGES_PER_TILE))->get_owner()->get_id() == p.get_id()) // i - 1 might be a nagative number
                        valid1 = true;
                    ...
                    if (!tile->get_edges().at(good_mod(i + 1, EDGES_PER_TILE))->get_owner()->get_id() == p.get_id()) // i + 1 might be > EDGES_PER_TILE
                        valid2 = true;
